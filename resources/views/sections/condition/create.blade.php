  ...
  <section class="section">
    <div class="row">
      <div class="col-lg-12">
        ...
        <div class="card">
          <div class="card-body">
            <h5 class="card-title">Matin Yaratish</h5>

            <!-- General Form Elements -->
            <form action="{{ route('condition.store') }}" method="POST" enctype="multipart/form-data">
              @csrf
              ...
              <div class="row mb-3">
                <label class="col-sm-2 col-form-label">Saqlash Tugmasi</label>
                <div class="col-sm-10">
